...
<head>
  ...
  <title>Hooked :: Fishing Reels</title>
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          ...
          <a href="reel.php" class="list-group-item active">Reels</a>
      ...
      <div class="col-lg-9">
         ...
         <h4 class="my-4">Fishing Reels</h4>
         ...
         <!-- NEW CODE -->
            <?php
               $item = $db->prepare("SELECT * FROM item WHERE category_id = 2");
               $item->execute();
