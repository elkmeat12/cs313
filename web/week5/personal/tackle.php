...
<head>
  ...
  <title>Hooked :: Fishing Tackle</title>
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          ...
          <a href="tackle.php" class="list-group-item active">Tackle</a>
      ...
      <div class="col-lg-9">
         ...
         <h4 class="my-4">Fishing Tackle</h4>
         ...
         <!-- NEW CODE -->
            <?php
               $item = $db->prepare("SELECT * FROM item WHERE category_id = 4");
               $item->execute();
