...
<head>
  ...
  <title>Hooked :: Fishing Line</title>
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          ...
          <a href="line.php" class="list-group-item active">Line</a>
      ...
      <div class="col-lg-9">
         ...
         <!-- NEW CODE -->
            <?php
               $item = $db->prepare("SELECT * FROM item WHERE category_id = 3");
               $item->execute();
